...
# read the distance from sun for two planets, and then display the distance between the planets using input(), int() to convert integers and then abs() to convert the results into its absolute value
