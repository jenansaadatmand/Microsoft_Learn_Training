...
print(15-3)
print()
print('Find how far a rocket has gone by multiplying speed by time travelling')
print(17000*2)
print()
...
print(10%3)
print()
print('Calculate exponential operator 10^ 5.37 using **, two astricks')
print(10**3.527)
print()
